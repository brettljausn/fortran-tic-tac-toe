...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tictactoe.exe: ${OBJECTFILES}
	...
	${LINK.f} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tictactoe ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/gamelogic_module.o: gamelogic_module.f03
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/gamelogic_module.o gamelogic_module.f03

${OBJECTDIR}/output_module.o: output_module.f03
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/output_module.o output_module.f03

${OBJECTDIR}/tictactoe.o: tictactoe.f03
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/tictactoe.o tictactoe.f03
